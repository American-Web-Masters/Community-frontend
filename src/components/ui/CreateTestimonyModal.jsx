...
const CreateTestimonyModal = ({ isOpen, onClose, onSuccess, initialData = null }) => {
  ...
  const setVerseField = (key, value) => {
    setForm((p) => ({
      ...p,
      [key]: value,
      // Clear fetched content when changing the query.
  ...
  return (
    <div
      ...
      aria-label={title}
    >
      <div className="w-full max-w-3xl overflow-hidden rounded-2xl sm:rounded-3xl bg-white shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4)] transform transition-all duration-300 animate-in zoom-in-95 slide-in-from-bottom-4 ease-out max-h-[92vh] sm:max-h-[90vh] flex flex-col">
        {/* Header */}
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="min-h-[150px] sm:min-h-[190px] w-full resize-none rounded-2xl sm:rounded-3xl border border-gray-200 px-5 py-4 text-gray-800 placeholder-gray-400 outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-400 bg-white/70 backdrop-blur-sm shadow-inner transition-all duration-300"
              ...
              <div className="rounded-3xl border border-gray-200 p-4">
                ...
                <div className="mt-3 space-y-3">
                  ...
                  <textarea
                    ...
                    readOnly
                    className="min-h-[80px] sm:min-h-[88px] w-full resize-none rounded-2xl border border-gray-200 bg-gray-50 px-5 py-3.5 text-gray-800 placeholder-gray-400 outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-400 bg-white/70 backdrop-blur-sm shadow-inner transition-all duration-300"
              ...
              <div className="rounded-3xl border border-gray-200 p-4">
                ...
                <div className="mt-3 flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={addTag}
                    className="rounded-2xl bg-[color:var(--color-primary-600)] px-5 py-3.5 text-sm font-semibold text-white hover:bg-[color:var(--color-primary-700)] shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-0.5 disabled:opacity-50"
